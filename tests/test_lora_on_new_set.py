...
def evaluate_on_new_dataset(model_path, config, save_dir):
    """
    Evaluate the LoRA model on the EnMAP dataset.
    ...
    with open(save_dir / 'test_results.txt', 'w') as f:
        f.write("=== LoRA Model Test Results on EnMAP Dataset ===\n\n")
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'save_dir': './lora_new_dataset_results',  # Changed directory name
    ...
    checkpoint_path = '/home/akram/Downloads/ssl_v9/ssl_v10_fc/ssl_v10_conv/ssl_v10_unet/ssl_v11_with_new_model/ssl_12_with_lora/UNETDecoder/ssl_15/ssl_16/ssl_17/ssl_18/lora_results/checkpoint_epoch_243.pt'
