...
def evaluate_on_test_set(checkpoint_path, config):
    """
    Evaluate the LoRA model on the entire test set.
    ...
    if 'model_state_dict' in checkpoint:
        ...
        # Print LoRA state information if available
        ...
        for batch_idx, (noisy, clean) in enumerate(tqdm(test_loader)):
            ...
            for i in range(noisy.size(0)):
                ...
                if batch_idx % 100 == 0 and i == 0:
                    ...
                    axes[2].set_title(f'Denoised Image (LoRA)\nPSNR: {psnr:.2f}dB')
    ...
    with open(save_dir / 'test_results.txt', 'w') as f:
        f.write("=== LoRA Model Test Results ===\n\n")
...
if __name__ == "__main__":
    ...
    checkpoint_path = './lora_results/checkpoint_epoch_243.pt'
    # Alternative: use merged model
    # checkpoint_path = './lora_results/merged_model_epoch_999.pt'
